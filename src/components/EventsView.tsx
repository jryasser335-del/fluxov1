  ...
  return (
    <div className="space-y-0">
      ...
      <div className="relative mb-6">
        ...
        {/* Sport Tabs - Premium pill design */}
        ...
        {/* Sub-league filter - subtle & minimal */}
      ...
      {/* Bottom counter - premium minimal */}
      <div className="flex items-center justify-center pt-10 pb-3">
        <div className="flex items-center gap-2.5 px-5 py-2.5 rounded-2xl bg-white/[0.015] border border-white/[0.03] backdrop-blur-sm">
          ...
          <span className="text-[11px] text-primary/40 font-medium tabular-nums">{stats.withLinks} con señal</span>
        </div>
      </div>
    </div>
  );

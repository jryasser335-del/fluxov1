...
const Index = () => {
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-[86px_1fr] max-md:grid-cols-[78px_1fr] min-h-screen relative bg-[hsl(0_0%_4%)]">
        {/* Ambient background effects */}
        <div className="fixed inset-0 pointer-events-none overflow-hidden">
          <div className="absolute top-0 left-1/3 w-[600px] h-[400px] bg-primary/8 blur-[150px] rounded-full" />
          <div className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] bg-orange-500/5 blur-[120px] rounded-full" />
        </div>
